<?php
    ...
    {
        $account = new \Authentication\Account(\Authentication\AccountManager::getKey());
    }
    else
    {
        $_SESSION["authredirect"] = "/account";
        header('Location: ' . '/nextgen' . '/account/login/');
    }
?>
<!DOCTYPE HTML>
<!--
						...
						<div class="8u">
							...
							<!-- Content -->
								<article id="content">
									<header>
										<h2>Blog</h2>
										<p>Up-to-date information on my projects and teachings.</p>
									</header>
